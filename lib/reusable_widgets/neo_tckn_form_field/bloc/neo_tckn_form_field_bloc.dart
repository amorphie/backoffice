...
class NeoTcknFormFieldBloc extends Bloc<NeoTcknFormFieldEvent, NeoTcknFormFieldState> {
  ...
  void _onTcknFormFieldUpdated(NeoTcknFormFieldEventUpdateTcknFormField event, Emitter<NeoTcknFormFieldState> emit) {
    _hasError = !isValidTcknOrVkn(event.value);
  ...
  bool isValidTcknOrVkn(String value) => _isValidTckn(value) || _isValidVkn(value);

  bool _isValidTckn(String value) {
    return _hasCorrectLength(value) &&
        _firstDigitNotZero(value) &&
        _lastDigitEven(value) &&
        _tenthDigitValid(value) &&
        _lastDigitValid(value);
  }
