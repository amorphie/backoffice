...
class ShowRedirectCameraSettingsPopupUseCase extends BaseShowPopupUseCase {
  @override
  Widget build(BuildContext context) {
    return NeoPopup(
      type: NeoPopupType.warning,
      titleText: LocalizationKey.generalCameraAccessPopupPictureTitle.loc(),
      bodyText: LocalizationKey.generalCameraAccessPopupPictureText.loc(),
      actions: [
        NeoPopupActionModel(
          labelText: LocalizationKey.generalCameraAccessPopupPictureButton.loc(), // STOPSHIP: Handle localization
