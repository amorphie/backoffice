...
import 'package:admin/core/localization/localizable_text.dart';
import 'package:admin/ui/reusable_widgets/brg_account_slider/brg_account_slider_widget_builder.dart';
    ...
    return GestureDetector(
      onTap: () {
        ...
        getIt.get<NeoWidgetEventBus>().addEvent(
              NeoWidgetEvent(
                eventId: BrgAccountSliderWidgetBuilder.kType,
                data: isFlipped,
              ),
            );
      },
